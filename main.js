// Blueberry — minimal vanilla JS for scroll-spy, cookie banner, sticky CTA
(() => {
  ...
  if (banner) {
    ...
    $('[data-cookie-more]', banner)?.addEventListener('click', (e) => {
      e.preventDefault();
      alert('Blueberry usa Vercel Analytics — analítica de páginas vistas sin cookies de terceros, anónima y agregada. No vendemos datos ni hacemos retargeting. Si rechazas, no se carga.');
    });
  }
